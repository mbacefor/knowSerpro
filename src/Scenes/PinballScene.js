...
export default class PinballScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.matter.add.polygon(10, 50, 8, 50, { isStatic: true });
    ...
    this.matter.add.fromVertices(200, 200, star, { restitution: 0.5, isStatic: true }, true);

    //  Some different joint types
    const body2 = this.matter.add.circle(150, 250, 16, { isStatic: true });
    const body3 = this.matter.add.circle(400, 450, 16, { isStatic: true });
    const body4 = this.matter.add.circle(500, 50, 16, { isStatic: true });
    ...
    //game.cameras.main.setBackgroundColor('#000000')

    // Enable Box2D physics

    this.matter.world.setGravity(0, 500);
   // game.physics.box2d.ptmRatio = 500;
    ...
    //var mainBody = this.matter.world.nextGroup();
    ...
    //  this.matter.add.fromVertices(0, 0, outlineVertices, { restitution: 0.5 }, true);
...
/**
    ...
    ballBody.setFixtureContactCallback(gutterFixture, this.onHitGutter, this);
